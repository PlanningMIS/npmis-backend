...
class Response(DRFResponse):
    """
    Customized API response format.

    This class standardizes the API response format.
    """
...
class ModelCopy:
    ...
    def __init__(
            self, model, condition=None, excludes=None, extra_kwargs=None, register_permission=False
    ):
        ...
        if register_permission:
            ModelPermission.register(model=model, permissions=(permission_object_copy,))
